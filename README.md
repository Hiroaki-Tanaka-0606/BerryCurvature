...
- Since Hamiltonian matrix should be Hermite, only upper triangle part and diagonal component are used in diagonalization procedure. However you probably should write down also lower triangle part so that the Hamiltonian matrix is clearly Hermite.
